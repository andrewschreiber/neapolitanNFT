...
// File: contracts/neapolitan.sol

pragma solidity 0.7.0;

/**
 * @title Neapolitan contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract Neapolitan is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    function mintNeapolitans(uint numberOfTokens) external payable {
